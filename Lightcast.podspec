#
#  Be sure to run `pod spec lint Lightcast.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Martin Kovachev" => "miracle@nimasystems.com" }
  # Or just: s.author    = "Martin Kovachev"
  # s.authors            = { "Martin Kovachev" => "miracle@nimasystems.com" }
  s.social_media_url   = "https://twitter.com/miraclebg"
